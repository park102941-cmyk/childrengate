...
var de = /* @__PURE__ */ __name((e, t, r, a) => {
  if (t && typeof t == "object" || typeof t == "function") for (let n of ne(t)) !ie.call(e, n) && n !== r && q(e, n, { get: /* @__PURE__ */ __name(() => t[n], "get"), enumerable: !(a = se(t, n)) || a.enumerable });
  return e;
}, "de");
var V = /* @__PURE__ */ __name((e, t, r) => (r = e != null ? re(oe(e)) : {}, de(t || !e || !e.__esModule ? q(r, "default", { value: e, enumerable: true }) : r, e)), "V");
var x;
var c = E(() => {
  x = { collectedLocales: [] };
});
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.8667287238094962.mjs.map
