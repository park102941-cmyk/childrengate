...
var ce = /* @__PURE__ */ __name2((e, t, s, a) => {
  if (t && typeof t == "object" || typeof t == "function") for (let n of ne(t)) !ie.call(e, n) && n !== s && H(e, n, { get: /* @__PURE__ */ __name2(() => t[n], "get"), enumerable: !(a = re(t, n)) || a.enumerable });
  return e;
}, "ce");
...
async function w(e, { request: t, assetsFetcher: s, ctx: a }, { path: n, searchParams: o }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        r = S(await s.fetch(L(c, e.path ?? n))), e.headers && y(r.headers, e.headers);
        break;
      }
      case "static": {
...
var fe = Symbol.for("__cloudflare-request-context__");
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let o = globalThis[fe], r = /* @__PURE__ */ __name2(async () => {
          let i = await e.json();
...
var k = class {
  ...
  applyLocaleRedirects(t) {
    ...
    let { locale: { redirect: a, cookie: n } } = t, o = n && this.cookies[n], r = A(o ?? ""), i = A(this.reqCtx.request.headers.get("accept-language") ?? ""), p = [...r, ...i].map((f) => a[f]).filter(Boolean)[0];
    if (p) {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=anwtu4o3qj5.js.map
