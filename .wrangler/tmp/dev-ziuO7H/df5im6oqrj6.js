...
// .wrangler/tmp/bundle-G91PWh/checked-fetch.js
...
// .wrangler/tmp/pages-7tlN0w/bundledWorker-0.4561711834473732.mjs
...
var va = { async fetch(e, t, r) {
  ...
  return n.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: b }, async () => o.run({ env: t, ctx: r, cf: e.cf }, async () => {
    if (new URL(e.url).pathname.startsWith("/_next/image")) return W(e, { buildOutput: m, assetsFetcher: t.ASSETS, imagesConfig: _.images });
    let i = B(e);
...
// .wrangler/tmp/pages-7tlN0w/df5im6oqrj6.js
...
// .wrangler/tmp/bundle-G91PWh/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-G91PWh/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=df5im6oqrj6.js.map
